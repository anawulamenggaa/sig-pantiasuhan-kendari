<?php
session_start();
require 'C:\xampp3\htdocs\tugas\data\scripts\leaflet\get_marker.php';
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <span class="navbar-brand">Leaflet Js Demo</span>
    ...
    <script>
        ...
        inputMarkerId.addEventListener('valueChangeMarkerId', (e) => {
            var toggleButtonInput = e.originalTarget.value !== "";
